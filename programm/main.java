...
public class main {
    ...
    static YoungAnimal young;
    static Scanner scanner;

    public static void main(String[] args) throws Exception {
        young = new YoungAnimal();

        young.addAnimal(new Dog("Арчи", "2018-10-15"));
        young.addAnimal((new Cat("Барсик", "2020-05-13")).addSkill("Не дри обои"));
        young.addAnimal(new Hamster("Славик", "2022-17-18"));
    ...
    private static void geekBrains() {
        ...
        Animal animal = young.getAnimal(name);
        if (animal != null) {
            System.out.println("Какой будет новая команда?");
            String skill = "";
            while (skill.equals("")) {
                System.out.print("> ");
            ...
            System.out.println(animal.getName() + " не теперь питомец умеет " + skill);
        } else {
